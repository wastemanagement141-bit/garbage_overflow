...
const Dashboard = () => {
    ...
    return (
        <div className="h-screen w-full overflow-hidden flex flex-col relative z-10 p-4 md:p-6 lg:p-8">
            ...
            <header className="flex-none flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
                <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1 text-sm md:text-base">IoT Garbage Overflow Management System</p>
                </div>
                <div className="flex items-center gap-2 text-slate-400 text-xs md:text-sm bg-white px-3 py-1.5 md:px-4 md:py-2 rounded-full shadow-sm border border-slate-100">
            ...
            <main className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 min-h-0 overflow-y-auto lg:overflow-hidden pb-2">
                ...
                <div className="lg:col-span-1 flex flex-col h-auto lg:h-full">
                    <div className="h-full flex flex-col justify-center">
                        {loading && !statusData ? (
                            <div className="bg-white h-96 w-full rounded-3xl shadow-xl p-8 flex items-center justify-center">
